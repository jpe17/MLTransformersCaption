...
def train_v2_02_with_modality():
    """
    V2_02: Training with modality embeddings - clean version based on v2_01 structure
    """
    
    device = "cuda" if torch.cuda.is_available() else "cpu"
    print(f"Using device: {device}")
    print("V2_02: Training WITH modality embeddings (clean version)")
