...
class CaptionDecoderFreezeAll(CaptionDecoderBase):
    """
    Version that freezes ALL QWEN layers, including the last 2
    """
    def __init__(self):
        super().__init__()
        
        # Freeze ALL of Qwen layers (including last 2)
        for param in self.qwen_model.parameters():
            param.requires_grad = False
        
        print("✅ ALL QWEN layers frozen (including last 2)")

def train_v2_02_freeze_all():
    """
    V2_02: Training with ALL QWEN layers frozen (including last 2)
    """
    ...
    print("V2_02: Training with ALL QWEN layers FROZEN")
    ...
    decoder = CaptionDecoderFreezeAll().to(device)
    
    # --- 2. Optimizer & Scheduler Setup ---
    # Only train image adapter, modality embeddings, and cross-attention parts
